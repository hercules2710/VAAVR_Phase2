...
public class UtimateTool : MonoBehaviour
{
    ...
    public void ActivateTool()
    {
       ...
       // if (!IsActiveTask(targetUseTool)) return;
        ...
        //use toolObjPoint rotation z look backward to tool tail and rotation x must point up
    ...
    public void DeactivateTool()
    {
        ...
        //twistObjScript.isAlreadyjoint = false;
            ...
            if (twistObjScript != null)
            {
                if(twistObjScript.twistDirection == TwistObj.TwistDirection.Right) // check direction in twist obj - Max = right, min = left
                {
                    ...
                    { 
                        ...
                        if (twistObjScript.isFinishedTwistIn)
                        {
                           // DeactivateTool();
                           // twistObjScript.isAlreadyjoint = true;
                            return;
                        }
                    }
                    else
                    {
                        ...
                        if (twistObjScript.isFinishedTwistOut)
                        {
                           // twistObjScript.isAlreadyjoint = true;
                            return;
                        }
